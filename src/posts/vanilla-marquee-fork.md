...
i created a fork of the vanilla-marquee module! my version is located [here (thrzl/vanilla-marquee)](https://github.com/thrzl/vanilla-marquee) and contains two major changes:
